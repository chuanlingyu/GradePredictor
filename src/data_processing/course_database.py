...
df['Primary Instructor'] = df['Primary Instructor'].str.split(',').str[0]
df['Primary Instructor'] = df['Primary Instructor'].str.upper()


df.to_csv("data/processed/cleaned_course_database.csv", index = False)